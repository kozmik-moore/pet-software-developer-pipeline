...
def activities_countplots(data: pd.DataFrame, save: bool = False, palette: str|None = None):
    ...
    ax = sns.countplot(a_df, x='activity_type', dodge=False)
    ax.set_xlabel('')
    ax.set_ylabel('')
...
def health_activities_boxplots(data: pd.DataFrame, by_type: bool = False, save: bool = True, palette: str|None = None):
...
def pet_counts(data: pd.DataFrame, save: bool = False, palette: str|None = None):
    if palette:
        sns.set_palette(palette)
...
def pet_counts_by_owner_age(data: pd.DataFrame, proportions: bool = False, save: bool = False, palette: str|None = None):
    """_summary_
